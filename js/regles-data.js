...
const REGLES_DIVERSES = [
  ...
  },
  {
    nom: "Chercheur d'Expiation",
    texte:
      "Posture de Défi de Hibou Khan (White Scars) qui lui permet de tenter d'éviter d'être Retiré comme Perte. Tant qu'une Figurine ayant cette Règle Spéciale est Engagée en Défi, son Joueur en Contrôle peut choisir cette Posture : si cette Figurine est réduite à 0 Point de Vie à l'Étape 4 de l'Étape de Frappe, son Joueur en Contrôle peut jeter un Dé — sur un résultat de 4+, cette Figurine n'est pas Retirée comme Perte, mais demeure Engagée en Défi avec une Caractéristique de Points de Vie de 1, et son Joueur en Contrôle gagne l'Avantage en Défi.",
  },
  {
    nom: "Artisan de Mort",
    texte:
